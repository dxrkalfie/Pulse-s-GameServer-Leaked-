...
static_assert(offsetof(AthenaNews_C_ExecuteUbergraph_AthenaNews, CallFunc_PlayAnimation_ReturnValue_1) == 0x000010, "Member 'AthenaNews_C_ExecuteUbergraph_AthenaNews::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaNews_C_ExecuteUbergraph_AthenaNews, CallFunc_GetActiveWidgetIndex_ReturnValue) == 0x000018, "Member 'AthenaNews_C_ExecuteUbergraph_AthenaNews::CallFunc_GetActiveWidgetIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaNews_C_ExecuteUbergraph_AthenaNews, K2Node_SwitchInteger_CmpSuccess) == 0x00001C, "Member 'AthenaNews_C_ExecuteUbergraph_AthenaNews::K2Node_SwitchInteger_CmpSuccess' has a wrong offset!");
static_assert(offsetof(AthenaNews_C_ExecuteUbergraph_AthenaNews, K2Node_Event_NewsStyle) == 0x00001D, "Member 'AthenaNews_C_ExecuteUbergraph_AthenaNews::K2Node_Event_NewsStyle' has a wrong offset!");
static_assert(offsetof(AthenaNews_C_ExecuteUbergraph_AthenaNews, K2Node_SwitchEnum_CmpSuccess) == 0x00001E, "Member 'AthenaNews_C_ExecuteUbergraph_AthenaNews::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
