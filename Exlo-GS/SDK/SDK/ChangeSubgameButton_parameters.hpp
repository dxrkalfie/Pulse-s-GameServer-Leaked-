...
static_assert(sizeof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton) == 0x000138, "Wrong size on ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton");
...
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_GetContext_ReturnValue_1) == 0x000020, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_GetContext_ReturnValue_2) == 0x000028, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_GetContext_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_GetSubGame_ReturnValue) == 0x000130, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_GetSubGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000131, "Member 'ChangeSubgameButton_C_ExecuteUbergraph_ChangeSubgameButton::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
