...
static_assert(offsetof(AthenaSeasonReward_C_ShowNextVariant, CallFunc_IsValid_ReturnValue_1) == 0x000108, "Member 'AthenaSeasonReward_C_ShowNextVariant::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_ShowNextVariant, CallFunc_GetItemVariantPreviews_ReturnValue_1) == 0x000110, "Member 'AthenaSeasonReward_C_ShowNextVariant::CallFunc_GetItemVariantPreviews_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_ShowNextVariant, CallFunc_Array_Length_ReturnValue_1) == 0x000120, "Member 'AthenaSeasonReward_C_ShowNextVariant::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(AthenaSeasonReward_C_ViewInVault, CallFunc_IsValid_ReturnValue_1) == 0x000038, "Member 'AthenaSeasonReward_C_ViewInVault::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_float_Variable_1) == 0x00000C, "Member 'AthenaSeasonReward_C_SetState::Temp_float_Variable_1' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_bool_Variable_1) == 0x000010, "Member 'AthenaSeasonReward_C_SetState::Temp_bool_Variable_1' has a wrong offset!");
...
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_byte_Variable_1) == 0x000019, "Member 'AthenaSeasonReward_C_SetState::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_bool_Variable_2) == 0x00001A, "Member 'AthenaSeasonReward_C_SetState::Temp_bool_Variable_2' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, K2Node_Select_Default_1) == 0x00001B, "Member 'AthenaSeasonReward_C_SetState::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_byte_Variable_2) == 0x00001C, "Member 'AthenaSeasonReward_C_SetState::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_byte_Variable_3) == 0x00001D, "Member 'AthenaSeasonReward_C_SetState::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_byte_Variable_4) == 0x00001E, "Member 'AthenaSeasonReward_C_SetState::Temp_byte_Variable_4' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, K2Node_Select_Default_2) == 0x00001F, "Member 'AthenaSeasonReward_C_SetState::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_byte_Variable_5) == 0x000020, "Member 'AthenaSeasonReward_C_SetState::Temp_byte_Variable_5' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_bool_Variable_3) == 0x000021, "Member 'AthenaSeasonReward_C_SetState::Temp_bool_Variable_3' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, K2Node_Select_Default_3) == 0x000022, "Member 'AthenaSeasonReward_C_SetState::K2Node_Select_Default_3' has a wrong offset!");
