...
static_assert(offsetof(AthenaFPS_C_ShowFPSChanged, Temp_byte_Variable_1) == 0x000003, "Member 'AthenaFPS_C_ShowFPSChanged::Temp_byte_Variable_1' has a wrong offset!");
...
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(AthenaFPS_C_ExecuteUbergraph_AthenaFPS, K2Node_DynamicCast_AsFort_Player_Controller) == 0x000020, "Member 'AthenaFPS_C_ExecuteUbergraph_AthenaFPS::K2Node_DynamicCast_AsFort_Player_Controller' has a wrong offset!");
