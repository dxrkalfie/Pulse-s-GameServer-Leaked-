...
static_assert(offsetof(BattlePassDirectAcquisitionScreen_C_ExecuteUbergraph_BattlePassDirectAcquisitionScreen, CallFunc_GetContext_ReturnValue_1) == 0x0000D8, "Member 'BattlePassDirectAcquisitionScreen_C_ExecuteUbergraph_BattlePassDirectAcquisitionScreen::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BattlePassDirectAcquisitionScreen_C_ExecuteUbergraph_BattlePassDirectAcquisitionScreen, CallFunc_GetContext_ReturnValue_2) == 0x0000E0, "Member 'BattlePassDirectAcquisitionScreen_C_ExecuteUbergraph_BattlePassDirectAcquisitionScreen::CallFunc_GetContext_ReturnValue_2' has a wrong offset!");
