...
static_assert(offsetof(CheckFeatureUnlockAction_C_ShowFeatureUnlock, CallFunc_GetContext_ReturnValue_1) == 0x000018, "Member 'CheckFeatureUnlockAction_C_ShowFeatureUnlock::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
