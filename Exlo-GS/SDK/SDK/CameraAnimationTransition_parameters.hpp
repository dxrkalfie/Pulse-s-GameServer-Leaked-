...
static_assert(sizeof(CameraAnimationTransition_C_ExecuteUbergraph_CameraAnimationTransition) == 0x0001F0, "Wrong size on CameraAnimationTransition_C_ExecuteUbergraph_CameraAnimationTransition");
