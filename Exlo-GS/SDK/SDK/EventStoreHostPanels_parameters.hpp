...
static_assert(sizeof(EventStoreHostPanels_C_Setup_Details_Panels) == 0x000028, "Wrong size on EventStoreHostPanels_C_Setup_Details_Panels");
...
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_IsValid_ReturnValue_1) == 0x000002, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_GetType_ReturnValue) == 0x000003, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_GetType_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_GetSelectedTabId_ReturnValue) == 0x000008, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_GetSelectedTabId_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_SelectTabByID_ReturnValue) == 0x000010, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_SelectTabByID_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_GetTabButtonByID_ReturnValue) == 0x000018, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_GetTabButtonByID_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_GetVisibility_ReturnValue) == 0x000020, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_GetVisibility_ReturnValue' has a wrong offset!");
static_assert(offsetof(EventStoreHostPanels_C_Setup_Details_Panels, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000021, "Member 'EventStoreHostPanels_C_Setup_Details_Panels::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
