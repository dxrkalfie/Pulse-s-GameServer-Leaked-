...
static_assert(sizeof(UAthenaSeasonReward_C) == 0x000BE8, "Wrong size on UAthenaSeasonReward_C");
static_assert(offsetof(UAthenaSeasonReward_C, UberGraphFrame) == 0x000B48, "Member 'UAthenaSeasonReward_C::UberGraphFrame' has a wrong offset!");
...
static_assert(offsetof(UAthenaSeasonReward_C, StrongItemToRepresent) == 0x000BA0, "Member 'UAthenaSeasonReward_C::StrongItemToRepresent' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, SoundOnReveal) == 0x000BA8, "Member 'UAthenaSeasonReward_C::SoundOnReveal' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, ViewOnHover) == 0x000BB0, "Member 'UAthenaSeasonReward_C::ViewOnHover' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, SecondaryItem) == 0x000BB8, "Member 'UAthenaSeasonReward_C::SecondaryItem' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, ShowVariantTimer) == 0x000BC0, "Member 'UAthenaSeasonReward_C::ShowVariantTimer' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, ResetVariantTimer) == 0x000BC8, "Member 'UAthenaSeasonReward_C::ResetVariantTimer' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, VariantIndex) == 0x000BD0, "Member 'UAthenaSeasonReward_C::VariantIndex' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, WaitingForVaultToChange) == 0x000BD4, "Member 'UAthenaSeasonReward_C::WaitingForVaultToChange' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, TimeBetweenVariants) == 0x000BD8, "Member 'UAthenaSeasonReward_C::TimeBetweenVariants' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, TimeBetweenVariantsRestart) == 0x000BDC, "Member 'UAthenaSeasonReward_C::TimeBetweenVariantsRestart' has a wrong offset!");
static_assert(offsetof(UAthenaSeasonReward_C, VariantTimerIndex) == 0x000BE0, "Member 'UAthenaSeasonReward_C::VariantTimerIndex' has a wrong offset!");
