...
static_assert(sizeof(CheckForUnfloweringUITutorials_C_CanRunTutorialQuests) == 0x000028, "Wrong size on CheckForUnfloweringUITutorials_C_CanRunTutorialQuests");
...
static_assert(offsetof(CheckForUnfloweringUITutorials_C_CanRunTutorialQuests, CallFunc_GetCachedWidget_ReturnValue) == 0x000010, "Member 'CheckForUnfloweringUITutorials_C_CanRunTutorialQuests::CallFunc_GetCachedWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(CheckForUnfloweringUITutorials_C_CanRunTutorialQuests, K2Node_DynamicCast_AsDaily_Rewards) == 0x000018, "Member 'CheckForUnfloweringUITutorials_C_CanRunTutorialQuests::K2Node_DynamicCast_AsDaily_Rewards' has a wrong offset!");
static_assert(offsetof(CheckForUnfloweringUITutorials_C_CanRunTutorialQuests, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'CheckForUnfloweringUITutorials_C_CanRunTutorialQuests::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(CheckForUnfloweringUITutorials_C_CanRunTutorialQuests, CallFunc_IsCurrentlyRunning_Result) == 0x000021, "Member 'CheckForUnfloweringUITutorials_C_CanRunTutorialQuests::CallFunc_IsCurrentlyRunning_Result' has a wrong offset!");
static_assert(offsetof(CheckForUnfloweringUITutorials_C_CanRunTutorialQuests, CallFunc_Not_PreBool_ReturnValue) == 0x000022, "Member 'CheckForUnfloweringUITutorials_C_CanRunTutorialQuests::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
