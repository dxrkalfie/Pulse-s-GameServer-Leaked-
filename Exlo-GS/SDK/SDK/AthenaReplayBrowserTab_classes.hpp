...
static_assert(sizeof(UAthenaReplayBrowserTab_C) == 0x000410, "Wrong size on UAthenaReplayBrowserTab_C");
...
static_assert(offsetof(UAthenaReplayBrowserTab_C, ViewStreamingReplayRow) == 0x000400, "Member 'UAthenaReplayBrowserTab_C::ViewStreamingReplayRow' has a wrong offset!");
