...
static_assert(offsetof(ChoiceCardName_C_UpdateText, CallFunc_GetDynamicMaterial_ReturnValue_1) == 0x0000A8, "Member 'ChoiceCardName_C_UpdateText::CallFunc_GetDynamicMaterial_ReturnValue_1' has a wrong offset!");
