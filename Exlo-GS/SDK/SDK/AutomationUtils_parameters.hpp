...
static_assert(sizeof(AutomationUtilsBlueprintLibrary_TakeGameplayAutomationScreenshot) == 0x000018, "Wrong size on AutomationUtilsBlueprintLibrary_TakeGameplayAutomationScreenshot");
