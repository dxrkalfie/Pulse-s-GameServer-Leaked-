...
static_assert(offsetof(UCineCameraComponent, CurrentFocalLength) == 0x000860, "Member 'UCineCameraComponent::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, CurrentAperture) == 0x000864, "Member 'UCineCameraComponent::CurrentAperture' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, CurrentFocusDistance) == 0x000868, "Member 'UCineCameraComponent::CurrentFocusDistance' has a wrong offset!");
