...
static_assert(sizeof(ErrorEntry_C_ExecuteUbergraph_ErrorEntry) == 0x000020, "Wrong size on ErrorEntry_C_ExecuteUbergraph_ErrorEntry");
...
static_assert(offsetof(ErrorEntry_C_ExecuteUbergraph_ErrorEntry, CallFunc_Concat_StrStr_ReturnValue) == 0x000010, "Member 'ErrorEntry_C_ExecuteUbergraph_ErrorEntry::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
...
static_assert(alignof(ErrorEntry_C_SetErrorInfo) == 0x000008, "Wrong alignment on ErrorEntry_C_SetErrorInfo");
static_assert(sizeof(ErrorEntry_C_SetErrorInfo) == 0x000070, "Wrong size on ErrorEntry_C_SetErrorInfo");
