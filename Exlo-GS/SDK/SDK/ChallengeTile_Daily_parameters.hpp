...
static_assert(sizeof(ChallengeTile_Daily_C_SetDynamicColors) == 0x000090, "Wrong size on ChallengeTile_Daily_C_SetDynamicColors");
...
static_assert(offsetof(ChallengeTile_Daily_C_SetDynamicColors, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000088, "Member 'ChallengeTile_Daily_C_SetDynamicColors::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(ChallengeTile_Daily_C_OnChallengeSetEstablished) == 0x000088, "Wrong size on ChallengeTile_Daily_C_OnChallengeSetEstablished");
...
static_assert(offsetof(ChallengeTile_Daily_C_OnChallengeSetEstablished, bIsComplete) == 0x000080, "Member 'ChallengeTile_Daily_C_OnChallengeSetEstablished::bIsComplete' has a wrong offset!");
static_assert(offsetof(ChallengeTile_Daily_C_OnChallengeSetEstablished, bIsLocked) == 0x000081, "Member 'ChallengeTile_Daily_C_OnChallengeSetEstablished::bIsLocked' has a wrong offset!");
...
static_assert(sizeof(ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily) == 0x0000B0, "Wrong size on ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily");
...
static_assert(offsetof(ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily, K2Node_Event_bIsComplete) == 0x000090, "Member 'ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily::K2Node_Event_bIsComplete' has a wrong offset!");
static_assert(offsetof(ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily, K2Node_Event_bIsLocked) == 0x000091, "Member 'ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily::K2Node_Event_bIsLocked' has a wrong offset!");
static_assert(offsetof(ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily, CallFunc_PlayAnimationReverse_ReturnValue) == 0x000098, "Member 'ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily::CallFunc_PlayAnimationReverse_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily, CallFunc_PlayAnimationForward_ReturnValue) == 0x0000A0, "Member 'ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily, K2Node_Event_bHasPartyAssistedChallenge) == 0x0000A8, "Member 'ChallengeTile_Daily_C_ExecuteUbergraph_ChallengeTile_Daily::K2Node_Event_bHasPartyAssistedChallenge' has a wrong offset!");
