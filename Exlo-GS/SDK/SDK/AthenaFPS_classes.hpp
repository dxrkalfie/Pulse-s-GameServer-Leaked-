...
static_assert(sizeof(UAthenaFPS_C) == 0x000260, "Wrong size on UAthenaFPS_C");
static_assert(offsetof(UAthenaFPS_C, UberGraphFrame) == 0x000258, "Member 'UAthenaFPS_C::UberGraphFrame' has a wrong offset!");
