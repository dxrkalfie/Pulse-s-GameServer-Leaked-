...
static_assert(offsetof(BP_LiveStreamerDescription_C_Update_Viewer_Note_Visibility, Temp_byte_Variable_1) == 0x000002, "Member 'BP_LiveStreamerDescription_C_Update_Viewer_Note_Visibility::Temp_byte_Variable_1' has a wrong offset!");
...
static_assert(offsetof(BP_LiveStreamerDescription_C_Is_Viewer_Quest, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x000004, "Member 'BP_LiveStreamerDescription_C_Is_Viewer_Quest::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_LiveStreamerDescription_C_Update_Visibility, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x00000B, "Member 'BP_LiveStreamerDescription_C_Update_Visibility::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_LiveStreamerDescription_C_Update_Visibility, CallFunc_EqualEqual_ByteByte_ReturnValue_2) == 0x00000C, "Member 'BP_LiveStreamerDescription_C_Update_Visibility::CallFunc_EqualEqual_ByteByte_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_LiveStreamerDescription_C_Update_Visibility, Temp_byte_Variable_1) == 0x00000D, "Member 'BP_LiveStreamerDescription_C_Update_Visibility::Temp_byte_Variable_1' has a wrong offset!");
...
static_assert(offsetof(BP_LiveStreamerDescription_C_Update_Visibility, CallFunc_BooleanOR_ReturnValue_1) == 0x00000F, "Member 'BP_LiveStreamerDescription_C_Update_Visibility::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_LiveStreamerDescription_C_Set_Quest, K2Node_MakeStruct_FormatArgumentData_1) == 0x0000B8, "Member 'BP_LiveStreamerDescription_C_Set_Quest::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(BP_LiveStreamerDescription_C_Set_Quest, K2Node_MakeArray_Array_1) == 0x0000F8, "Member 'BP_LiveStreamerDescription_C_Set_Quest::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(BP_LiveStreamerDescription_C_Set_Quest, CallFunc_Format_ReturnValue_1) == 0x000108, "Member 'BP_LiveStreamerDescription_C_Set_Quest::CallFunc_Format_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_LiveStreamerDescription_C_Set_Quest, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x000138, "Member 'BP_LiveStreamerDescription_C_Set_Quest::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
