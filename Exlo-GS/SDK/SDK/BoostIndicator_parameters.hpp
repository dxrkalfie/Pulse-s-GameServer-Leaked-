...
static_assert(offsetof(BoostIndicator_C_IsPartyMemberBoosted, CallFunc_GetContext_ReturnValue_1) == 0x000018, "Member 'BoostIndicator_C_IsPartyMemberBoosted::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BoostIndicator_C_Update, Temp_byte_Variable_1) == 0x000005, "Member 'BoostIndicator_C_Update::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(BoostIndicator_C_Update, Temp_bool_Variable_1) == 0x000006, "Member 'BoostIndicator_C_Update::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(BoostIndicator_C_Update, Temp_byte_Variable_2) == 0x000007, "Member 'BoostIndicator_C_Update::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(BoostIndicator_C_Update, Temp_byte_Variable_3) == 0x000008, "Member 'BoostIndicator_C_Update::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(BoostIndicator_C_Update, Temp_bool_Variable_2) == 0x000009, "Member 'BoostIndicator_C_Update::Temp_bool_Variable_2' has a wrong offset!");
static_assert(offsetof(BoostIndicator_C_Update, Temp_byte_Variable_4) == 0x00000A, "Member 'BoostIndicator_C_Update::Temp_byte_Variable_4' has a wrong offset!");
static_assert(offsetof(BoostIndicator_C_Update, Temp_byte_Variable_5) == 0x00000B, "Member 'BoostIndicator_C_Update::Temp_byte_Variable_5' has a wrong offset!");
...
static_assert(offsetof(BoostIndicator_C_Update, K2Node_Select_Default_1) == 0x00000D, "Member 'BoostIndicator_C_Update::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(BoostIndicator_C_Update, K2Node_Select_Default_2) == 0x00000E, "Member 'BoostIndicator_C_Update::K2Node_Select_Default_2' has a wrong offset!");
...
static_assert(offsetof(BoostIndicator_C_Update, CallFunc_Greater_IntInt_ReturnValue_1) == 0x000024, "Member 'BoostIndicator_C_Update::CallFunc_Greater_IntInt_ReturnValue_1' has a wrong offset!");
