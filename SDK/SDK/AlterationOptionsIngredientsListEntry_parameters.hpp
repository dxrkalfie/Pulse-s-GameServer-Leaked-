...
static_assert(offsetof(AlterationOptionsIngredientsListEntry_C_SetIngredientCount, CallFunc_Conv_IntToText_ReturnValue_1) == 0x000090, "Member 'AlterationOptionsIngredientsListEntry_C_SetIngredientCount::CallFunc_Conv_IntToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AlterationOptionsIngredientsListEntry_C_SetIngredientCount, K2Node_MakeStruct_FormatArgumentData_1) == 0x0000A8, "Member 'AlterationOptionsIngredientsListEntry_C_SetIngredientCount::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
...
static_assert(offsetof(AlterationOptionsIngredientsListEntry_C_SetIngredientCount, K2Node_MakeArray_Array_1) == 0x0000F0, "Member 'AlterationOptionsIngredientsListEntry_C_SetIngredientCount::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(AlterationOptionsIngredientsListEntry_C_SetIngredientCount, CallFunc_Format_ReturnValue_1) == 0x000100, "Member 'AlterationOptionsIngredientsListEntry_C_SetIngredientCount::CallFunc_Format_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(AlterationOptionsIngredientsListEntry_C_ExecuteUbergraph_AlterationOptionsIngredientsListEntry, CallFunc_GetItemDefinition_ReturnValue_1) == 0x000018, "Member 'AlterationOptionsIngredientsListEntry_C_ExecuteUbergraph_AlterationOptionsIngredientsListEntry::CallFunc_GetItemDefinition_ReturnValue_1' has a wrong offset!");
