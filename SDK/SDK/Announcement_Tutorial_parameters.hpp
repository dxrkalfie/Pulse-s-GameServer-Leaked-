...
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, K2Node_HandleClientEvent_EventSource_1) == 0x000150, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::K2Node_HandleClientEvent_EventSource_1' has a wrong offset!");
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, K2Node_HandleClientEvent_EventFocus_1) == 0x000158, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::K2Node_HandleClientEvent_EventFocus_1' has a wrong offset!");
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, K2Node_HandleClientEvent_ClientEvent_1) == 0x000160, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::K2Node_HandleClientEvent_ClientEvent_1' has a wrong offset!");
...
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, K2Node_CreateDelegate_OutputDelegate_1) == 0x0002EC, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
...
static_assert(offsetof(Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial, CallFunc_GetContext_ReturnValue_1) == 0x000308, "Member 'Announcement_Tutorial_C_ExecuteUbergraph_Announcement_Tutorial::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(Announcement_Tutorial_C_AddTextLine, CallFunc_GetOwningPlayer_ReturnValue_1) == 0x000048, "Member 'Announcement_Tutorial_C_AddTextLine::CallFunc_GetOwningPlayer_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(Announcement_Tutorial_C_AddTextLine, CallFunc_Create_ReturnValue_1) == 0x000058, "Member 'Announcement_Tutorial_C_AddTextLine::CallFunc_Create_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(Announcement_Tutorial_C_RefreshTextLines, CallFunc_Array_Length_ReturnValue_1) == 0x00002C, "Member 'Announcement_Tutorial_C_RefreshTextLines::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(Announcement_Tutorial_C_GetLightboxVisibility, Temp_byte_Variable_1) == 0x00013C, "Member 'Announcement_Tutorial_C_GetLightboxVisibility::Temp_byte_Variable_1' has a wrong offset!");
