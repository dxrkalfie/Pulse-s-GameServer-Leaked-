...
static_assert(sizeof(AAnnounce_Gen_Conversation_C) == 0x000328, "Wrong size on AAnnounce_Gen_Conversation_C");
static_assert(offsetof(AAnnounce_Gen_Conversation_C, UberGraphFrame) == 0x000320, "Member 'AAnnounce_Gen_Conversation_C::UberGraphFrame' has a wrong offset!");
