...
static_assert(sizeof(UAthenaBattlePassTrackerWidget_C) == 0x0002A8, "Wrong size on UAthenaBattlePassTrackerWidget_C");
...
static_assert(offsetof(UAthenaBattlePassTrackerWidget_C, TierName) == 0x000290, "Member 'UAthenaBattlePassTrackerWidget_C::TierName' has a wrong offset!");
static_assert(offsetof(UAthenaBattlePassTrackerWidget_C, TierNumber) == 0x000298, "Member 'UAthenaBattlePassTrackerWidget_C::TierNumber' has a wrong offset!");
